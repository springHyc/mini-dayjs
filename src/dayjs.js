...
import { UNIT_TO_MS, MS, SECOND, MINUTE, HOUR, DAY, WEEK } from './constants.js';
import { cloneDate, formatWithTemplate, addCalendarMonths, addCalendarYears } from './utils.js';
...
export class Dayjs {
    ...
    isBefore(other) {
        const t =
            other instanceof Dayjs ? other.valueOf() : new Dayjs(parseToDate(other)).valueOf();
